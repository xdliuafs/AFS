...
%  f=less_EIco(M, N)
%  Description
%  f=less_EIco(M, N) returns a Boolean value to judge if an E#I element represented by M is less than the other represented by N. If M is less, f=1, otherwise f=0.
%  Examples
%  M=[0 1 4 7; 0 2 5 5]¡¯
%  M=
%      0	0
